          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="table-responsive">
                <form method="post" action="<?= site_url('setgroup/new') ?>">
                  <?= csrf_field() ?>
                  ...
                  <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tr>
                      <td>Deskripsi</td>
                      <td>
                        <input class="form-control" type="text" name="deskripsi" value="<?= old('deskripsi') ?>" required />
                    ...
                    <tr>
                      <td>Landing Page</td>
                      <td>
                        <input class="form-control" type="text" name="landing_page" value="<?= old('landing_page') ?>" required />
